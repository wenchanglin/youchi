...
#define SegmentedControl_Height 50.0
#define SegmentedControl_Width ([UIScreen mainScreen].bounds.size.width)
...
{
    CGRect rect4View = CGRectMake(.0f, y, SegmentedControl_Width, SegmentedControl_Height);
    if (self = [super initWithFrame:rect4View]) {
        ...
        _scrollView.contentSize = CGSizeMake([titles count]*width4btn, SegmentedControl_Height);
        _scrollView.showsHorizontalScrollIndicator = NO;
        
        for (int i = 0; i<[titles count]; i++) {
            
            UIButton *btn = [UIButton buttonWithType:UIButtonTypeCustom];
            btn.frame = CGRectMake(i*width4btn, .0f, width4btn, SegmentedControl_Height);
...
//            [btn setTitleColor:UIColorFromRGBValue(0x454545) forState:UIControlStateSelected];
            [btn setTitleColor:[AppConstants themeColor] forState:UIControlStateSelected];
        ...
        //  lineView
        //
        CGFloat height4Line = SegmentedControl_Height/2.0f;
        CGFloat originY = SegmentedControl_Height / 4;
        ...
        //  bottom lineView
        //
        _bottomLineView = [[UIView alloc] initWithFrame:CGRectMake(5.0f, SegmentedControl_Height-3, width4btn-10.0f, 3.0f)];
//        _bottomLineView.backgroundColor = UIColorFromRGBValue(0x454545);
        _bottomLineView.backgroundColor = [AppConstants themeColor];
