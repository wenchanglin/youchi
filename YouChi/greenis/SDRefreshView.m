...
CGFloat const SDTextIndicatorMargin = 25.0f;
CGFloat const SDTimeIndicatorMargin = 15.0f;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        timeIndicator.font = [UIFont systemFontOfSize:11];
...
- (void)setRefreshState:(SDRefreshViewState)refreshState
{
    ...
    switch (refreshState) {
        ...
        case SDRefreshViewStateRefreshing:
        {
            ...
            _textIndicator.text = NSLocalizedString(@"loading", @"");
...
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
        ...
        {
            _textIndicator.text = NSLocalizedString(@"shifanggengxin", @"");
        ...
        case SDRefreshViewStateNormal:
        {
            ...
            _timeIndicator.text = [NSString stringWithFormat:@"%@：%@", NSLocalizedString(@"zuihougengxin", @""), [self lastRefreshingTimeString]];
