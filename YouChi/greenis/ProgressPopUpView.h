...
@protocol ProgressPopUpViewDelegate;
@protocol ProgressPopUpViewDataSource;

@interface ProgressPopUpView : UIProgressView
...
@property (weak, nonatomic) id<ProgressPopUpViewDataSource> dataSource;

// delegate is only needed when used with a TableView or CollectionView - see below
@property (weak, nonatomic) id<ProgressPopUpViewDelegate> delegate;
@end
...
@protocol ProgressPopUpViewDataSource <NSObject>
- (NSString *)progressView:(ProgressPopUpView *)progressView stringForProgress:(float)progress;
...
- (BOOL)progressViewShouldPreCalculatePopUpViewSize:(ProgressPopUpView *)progressView;
@end
...
@protocol ProgressPopUpViewDelegate <NSObject>
- (void)progressViewWillDisplayPopUpView:(ProgressPopUpView *)progressView;

@optional
- (void)progressViewDidHidePopUpView:(ProgressPopUpView *)progressView;
@end
