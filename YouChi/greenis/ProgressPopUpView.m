...
@interface ProgressPopUpView() <PopUpViewDelegate>
...
- (void)setDataSource:(id<ProgressPopUpViewDataSource>)dataSource
{
...
- (void)setup
{
    ...
    self.popUpView = [[PopUpView alloc] initWithFrame:CGRectZero];
